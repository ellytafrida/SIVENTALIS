                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    ...
                                    <h5 class="card-title">{{$ruangan->pegawai->nama}}</h5>   
                                       ...
                                       <a href="{{ url("detail-ruangan/$ruangan->id") }}" class="btn btn-info"><span class="fa fa-info"></span> Lihat</a>
                                           <a href="{{ url("edit-ruangan/$ruangan->id") }}" class="btn btn-warning"><span class="fa fa-edit"></span> Edit</a>
                                           <a href="{{ url("delete-ruangan/$ruangan->id") }}"
