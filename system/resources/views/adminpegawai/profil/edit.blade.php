...
@section('content')
    ...
    <div class="card">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card-body">
                <form action="{{url('update-profilpegawai', $pegawai->id)}}" method="post" enctype="multipart/form-data"> 
                    @csrf
                    @method("PUT")
                    ...
                    <div class="form-group row">
                        <label for="inputEmail2" class="col-3 col-lg-2 col-form-label">Unit Jurusan</label>
                        <div class="col-9 col-lg-10">
